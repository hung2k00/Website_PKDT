...
<?php
	...
	public function get_compare($customer_id){
		$query = "SELECT * FROM tbl_compare INNER JOIN tbl_product on tbl_compare.productId =tbl_product.productId  WHERE customer_id = '$customer_id' order by id desc";
		$result = $this->db->select($query);
		return $result;
	}
