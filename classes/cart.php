	...
	class cart
	{
		...
		public function add_to_cart($quantity, $id){
			...
			if($result_check_cart){
				...
				if($insert_cart){
					$msg = "<span class='sucess'>Thêm sản phẩm thành công</span>";
					return $msg;
		...
		public function update_quantity_cart($quantity, $cartId){
			...
			if($result){
				$msg = "<span class='success'>Cập nhật sản phẩm thành công</span>";
				return $msg;
			}else{
				$msg = "<span class='error'Cập nhật nhật sản phẩm không thành công</span>";
				return $msg;
			}
		...
		public function del_shifted($id,$time,$price){
			...
			if($result){
				...
				$msg = "<span class='error'>Xoá đơn hàng không thành công</span>";
				return $msg;
			}
		}
